        ...
        <section className="bg-chabad-brown/20 border-y border-chabad-gold/20">
          <div className="max-w-6xl mx-auto px-6 py-16">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-xs bg-chabad-amber text-chabad-dark px-2 py-1 rounded font-bold">Live</span>
            </div>
            <div className="grid md:grid-cols-3 gap-5">
              {announcements.map(a => (
                <div key={a.id}
                  className="bg-chabad-dark border border-chabad-gold/20 rounded-xl p-5">
                  <div className="text-xs text-chabad-amber uppercase tracking-widest font-bold mb-2">{a.type.replace('_', ' ')}</div>
